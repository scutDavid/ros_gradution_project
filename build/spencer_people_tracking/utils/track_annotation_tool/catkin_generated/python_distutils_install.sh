...
echo_and_run cd "/home/wwh/qqq/src/spencer_people_tracking/utils/track_annotation_tool"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/wwh/qqq/build/spencer_people_tracking/utils/track_annotation_tool" \
    install \
    $DESTDIR_ARG \
