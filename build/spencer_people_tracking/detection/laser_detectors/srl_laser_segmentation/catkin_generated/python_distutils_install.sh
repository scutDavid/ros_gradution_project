...
echo_and_run cd "/home/wwh/qqq/src/spencer_people_tracking/detection/laser_detectors/srl_laser_segmentation"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/wwh/qqq/build/spencer_people_tracking/detection/laser_detectors/srl_laser_segmentation" \
    install \
    $DESTDIR_ARG \
