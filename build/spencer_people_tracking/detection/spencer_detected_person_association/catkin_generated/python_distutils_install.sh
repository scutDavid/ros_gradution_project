...
echo_and_run cd "/home/wwh/qqq/src/spencer_people_tracking/detection/spencer_detected_person_association"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/wwh/qqq/build/spencer_people_tracking/detection/spencer_detected_person_association" \
    install \
    $DESTDIR_ARG \
