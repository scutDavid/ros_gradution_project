...
echo_and_run cd "/home/wwh/qqq/src/spencer_people_tracking/tracking/people/srl_tracking_logfile_import"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/wwh/qqq/build/spencer_people_tracking/tracking/people/srl_tracking_logfile_import" \
    install \
    $DESTDIR_ARG \
