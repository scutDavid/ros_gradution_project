...
class VisualOdometry {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('transformation_matrix')) {
        this.transformation_matrix = initObj.transformation_matrix
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [transformation_matrix]
    bufferOffset = _arraySerializer.float64(obj.transformation_matrix, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VisualOdometry(null);
    ...
    // Deserialize message field [transformation_matrix]
    data.transformation_matrix = _arrayDeserializer.float64(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.transformation_matrix.length;
    return length + 54;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VisualOdometry(null);
    ...
    if (msg.transformation_matrix !== undefined) {
      resolved.transformation_matrix = msg.transformation_matrix;
    }
    else {
      resolved.transformation_matrix = []
    }
